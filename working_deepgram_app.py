#!/usr/bin/env python3
"""
MedAgg Healthcare POC - Working Deepgram Voice Agent
Simplified version that works reliably with Twilio
"""
...
def transcribe_with_deepgram(audio_data, language="english"):
    """Transcribe audio using Deepgram API"""
    try:
        # Map language to Deepgram language codes
        lang_map = {
            "english": "en-US",
            "tamil": "ta-IN", 
            "hindi": "hi-IN"
    ...
    <body>
        <div class="container">
            ...
            <div class="info">
                ...
                <p><strong>Deepgram API:</strong> ✅ Configured</p>
            </div>
...
def twiml_endpoint():
    """TwiML endpoint for Twilio calls with Deepgram integration"""
    try:
        # Get language from query params or form data
...
def process_speech():
    """Process speech input from Twilio with Deepgram enhancement"""
    try:
...
def register_patient():
    ...
    try:
        ...
        response = {
            ...
            'voice_agent': 'Deepgram Enhanced Recognition',
            'public_url': PUBLIC_URL
        }
...
if __name__ == '__main__':
    ...
    logger.info("📞 Twilio integration with speech recognition")
