#!/usr/bin/env python3
"""
MedAgg Healthcare Voice Agent - Flask with WebSocket Support
Single-port solution for Render deployment
"""
...
def twilio_websocket():
    """WebSocket endpoint for Twilio - This will be handled by the WebSocket server"""
