#!/usr/bin/env python3
"""
MedAgg Healthcare POC - Ultra Simple Backend
Minimal, robust backend with Twilio integration
"""
    ...
    def do_POST(self):
        try:
            if self.path == '/register-patient':
                ...
                # Make Twilio call in a separate thread to avoid blocking
                def make_call():
...
def start_backend():
    ...
    print("🏥 MedAgg Healthcare POC Backend - ULTRA SIMPLE")
    print("=" * 50)
