# This file contains the actual Pydantic schemas
from pydantic import BaseModel, Field
from datetime import datetime
from typing import Optional, List
from database import GenderEnum, MedicalCategoryEnum, SubCategoryEnum, CallStatusEnum, AppointmentStatusEnum, LanguageEnum
...
class PatientBase(BaseModel):
    ...
    language_preference: LanguageEnum = Field(default=LanguageEnum.ENGLISH)
